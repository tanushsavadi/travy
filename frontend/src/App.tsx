...
function App() {
  ...
  const [currPage, setCurrPage] = useState<("home" | "community" | "profile")>("home");
            ...
            <ul>
              <li>
                <Link 
                  ...
                  style={currPage === "home" ? {color: 'orange'} : {}}
                  >
                    Home
                </Link>
              </li>
              <li>
                <Link 
                  ...
                  style={currPage === "community" ? {color: 'orange'} : {}}
                >
                  Community
                </Link>
              </li>
              <li>
                <Link 
                  ...
                  style={currPage === "profile" ? {color: 'orange'} : {}}
                >
                  Profile
                </Link>
              </li>
